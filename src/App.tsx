...
export default function App() {
  ...
  const products = [
    ...
    },
    {
      ...
      image: 'https://lh3.googleusercontent.com/d/1u2Jf9BlTgUeY_UZ0rQU5Nk6CQwfvia0R=w500',
      description:
        'Our largest and best-value bottle — built for families or dedicated long-term users. Six full months of deep Ayurvedic care. The complete 108-herb formula delivers maximum root-to-tip transformation with every application.',
      rating: 4.9,
      reviews: 174,
      inStock: true,
      bestseller: false,
                ...
                >
                  ...
                  <h1 className="font-serif mb-5 md:mb-8">
                    <motion.span
                      ...
                      className="block text-[2.2rem] sm:text-5xl md:text-6xl lg:text-[4.2rem] text-brand-bark font-bold leading-[1.1] tracking-[-0.01em]"
                    >
                      Adivasi herbal
                    </motion.span>
                    ...
                    <motion.span
                      initial={{ opacity: 0, y: 28 }}
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 0.62, duration: 0.95, ease: [0.19, 1, 0.22, 1] }}
                      className="block text-[2.5rem] sm:text-5xl md:text-[3.8rem] lg:text-[4.2rem] font-bold leading-[1.05]"
                    >
                      <span className="text-brand-leaf">hairoil</span>{' '}
                      <span className="relative inline-block">
                        <span className="relative z-10 text-brand-bark">since 1999</span>
                        <span className="absolute inset-x-0 bottom-1 h-[0.22em] bg-brand-gold/25 rounded-sm -z-0" />
                      </span>
                    </motion.span>
                  </h1>
                  <motion.div
